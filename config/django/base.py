...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'fundinfo.core.context_processors.cart'
            ],
        },
    },
]
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='psql://blackroom:a.b.33!?@127.0.0.1:5432/fundinfo'),
}
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'fundinfo.api.exception_handlers.drf_default_with_modifications_exception_handler',
    # 'EXCEPTION_HANDLER': 'fundinfo.api.exception_handlers.hacksoft_proposed_exception_handler',
